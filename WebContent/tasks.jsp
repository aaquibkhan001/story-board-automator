                            ...
                            if (isEmpty(histDescription) || ($("#updateAssigneeDropdown").jqxDropDownList('getSelectedItem') == 'undefined' || $("#updateAssigneeDropdown").jqxDropDownList('getSelectedItem') == null)) {
                                ...
                                if (!isEmpty(sessionStorage.userDetails) && sessionStorage.userDetails != 'undefined') {
                                    ...
                                    var history = {
                                        ...
                                        "taskHistoryDescription": histDescription
                                    }
                        ...
                        <div class="modal-body col-md-12">
                            <form class="form-horizontal col-md-12">
                                ...
                                <div class="form-group required">
                                    ...
                                    <textarea class="form-control" id="description" rows="8" placeholder="Enter Description" name="desc"></textarea>
                                </div>
                                ...
                                <div class="form-group required">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" id="status">
                                            ...
                                            <option value="inProgress">Test Ready</option>
                                            <option value="inProgress">Blocked</option>
                                            <option value="inProgress">Ready for PROD</option>
